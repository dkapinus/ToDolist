...
export const UpdateTask = () => {
    ...
    useEffect(() => {
        ...
        taskAPI.updateTask(todolistId,id,{title:'React',deadline:'',description:'',priority:TaskPriorities.Middle,startDate:'',status:TaskStatuses.Completed ,taskDisable:'idle'}).then((res) => {
            setState(res.data)
        })
