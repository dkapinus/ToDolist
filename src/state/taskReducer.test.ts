...
import {addTaskAC, changeInputTaskAC, changeStatusTaskAC, removeTaskAC, taskReducer} from "./taskReducer";
import {addTodolistAC} from "./todoReducer";

let startState:TaskKeyType
...
test('title task should be changed', () => {
    ...
    const action = changeInputTaskAC( 'todolistId2','2', 'meat')
